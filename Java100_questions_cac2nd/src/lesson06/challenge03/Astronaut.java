...
class Spaceship {
	...
	int comsumingFuel(int cousumingFuel) {
		int ligthYears = cousumingFuel * 10;
		fuel -= cousumingFuel;
		return ligthYears;
	}
...
public class Astronaut {
	...
	public static void main(String[] args) throws IOException {
		...
		//ここに適切な処理を記述する。
		System.out.println(spaceship.comsumingFuel() + "光年");
		...
		//ここに適切な処理を記述する。
		System.out.println(spaceship.comsumingFuel(consumingFuel) + "光年");
